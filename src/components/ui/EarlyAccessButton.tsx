...
export const EarlyAccessButton = ({
    ...
    const base =
        "bg-black font-bold text-white rounded-full transition-all disabled:opacity-50 disabled:cursor-not-allowed hover:bg-neutral-800 hover:scale-[1.02] active:scale-[0.98] cursor-pointer";
